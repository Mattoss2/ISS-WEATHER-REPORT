...
data |= (1 << (8 - i)); // high front and low in the post
while (digitalRead(DHpin) == HIGH); // data '1 ', wait for thenext one
// receiver
}
return data;
}
...
// sending data
for(int i = 0; i < 5; i++) // receive temperature and humidity data, the
// parity bit is not considered
dat[i] = read_data();
